/*
  === ESP32 + INMP441 Sound Level Monitor (v2.1) ===
  📌 Cập nhật:
...
void setup() {
  ...
  Serial.println("=== ESP32 + INMP441: Real-time FFT & dB (v2.1) ===");
...
void loop() {
  ...
  double dB = 20 * log10(rms / 0.00002);  // 20 µPa là ngưỡng nghe được
